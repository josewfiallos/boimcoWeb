...
function run(){
  ...
  if (isset($_POST["btnRegistrarse"])){
    ...
    if(!validar('nombre',$_POST["nombreUsuario"]) ) {
      $boolValidar=false;
      echo "<script>alert('Error! Nombre ingresado con caracteres no permitidos. Por favor verifique sus datos');</script>";
    }
    if(!validar('nombre',$_POST["apellidoUsuario"]) ) {
      $boolValidar=false;
      echo "<script>alert('Error! Apellido ingresado con caracteres no permitidos.  Por favor verifique sus datos');</script>";
    }
